...
namespace MIlkDairy.DataAccess.Migrations
{
    ...
    [Migration("20250306180334_AddedNewcolumnSessionIdToDB")]
    partial class AddedNewcolumnSessionIdToDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.ShoppingCart", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.subcategoiesMilk", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MilkDairy.Model.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MilkDairy.Model.ApplicationUser", b =>
                {
                    b.HasOne("MilkDairy.Model.Models.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.OrderDetail", b =>
                {
                    b.HasOne("MilkDairy.Model.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MilkDairy.Model.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MilkDairy.Model.Models.OrderHeader", b =>
                {
                    b.HasOne("MilkDairy.Model.ApplicationUser", "ApplicationUser")
                        .WithMany()
